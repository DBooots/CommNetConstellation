...
namespace CommNetConstellation.CommNetLayer
{
    ...
    public class CNCCommNetUI : CommNetUI
    {
        ...
        private Color getConstellationColor(CommNode a, CommNode b)
        {
            ...
            CNCCommNetVessel vesselA = ((IModularCommNetVessel)a.GetVessel().Connection).GetModuleOfType<CNCCommNetVessel>();
            //(CNCCommNetVessel)CNCCommNetScenario.Instance.findCorrespondingVessel(a).Connection;
            CNCCommNetVessel vesselB = ((IModularCommNetVessel)b.GetVessel().Connection).GetModuleOfType<CNCCommNetVessel>();
